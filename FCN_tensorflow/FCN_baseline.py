...
tf.flags.DEFINE_string("result_log", "../../results/1013_baseline/result.log", "path to mPA log")
tf.flags.DEFINE_integer("batch_size", "1", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "../../results/1013_baseline/checkpoints/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir",  "../../results/1013_baseline/vis/", "path to save results of visualization")
